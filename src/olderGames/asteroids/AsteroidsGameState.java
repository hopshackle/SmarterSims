...
import static olderGames.asteroids.Constants.height;
import static olderGames.asteroids.Constants.width;
...
public class AsteroidsGameState implements AbstractGameState {
    ...
    @Override
    public AsteroidsGameState copy(int i) {
        return copy();
    }
...
//    }
    ...
    @Override
    public int codonsPerAction() { return 1;}
}
