...
import static olderGames.asteroids.Asteroid.stroke;
...
public class View extends JComponent {
    ...
    public void paintComponent(Graphics gx) {
        ...
        // to wrap the olderGames.asteroids that have been projected off the screen
...
//        g.drawString("Hello", 100, 100);
    ...
    private void drawShipPlayout(Graphics2D g, Ship ship, int[] seq) {
        ...
        path.moveTo(ship.s.getX(), ship.s.getY());
...
//            }
            ...
            path.lineTo(ship.s.getX(), ship.s.getY());
        }
        g.draw(path);
    ...
    public void paintState(Graphics2D g) {
        ...
        g.setFont(font);
        String str = "" + gameState.score() + " : " + gameState.forwardModel.nLives + " : " + gameState.state
